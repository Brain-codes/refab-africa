...
export default function ImpactCard({ title, description }: ImpactCardProps) {
  return (
    <div className="flex gap-[clamp(0.82rem,1.65vw,1.65rem)] md:rounded-default rounded-sm border border-primary-dark bg-overlay-white-15 p-[clamp(0.82rem,1.3vw,1.33rem)_clamp(0.62rem,1vw,0.97rem)] backdrop-blur-sm">
      {/* Tear-drop icon */}
