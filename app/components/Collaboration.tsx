...
export default function Collaboration() {
  return (
    <section className="w-full overflow-hidden bg-background px-[5%] py-[clamp(4rem,8vw,7rem)]">
      <div className="mx-auto max-w-432">
        {/* ── Section Header ── */}
        <FadeIn direction="up" as="div">
          <div className="mb-[clamp(3rem,6vw,6rem)] flex flex-col items-center gap-4 text-center">
            {/* Badge */}
            ...
            {/* Description */}
            <p className="mx-auto max-w-321 text-[clamp(0.875rem,1.5vw,1.2rem)] leading-design text-primary-deepest">
        ...
        {/* ── Partner Brands Grid ── */}
        <StaggerContainer
          className="flex flex-wrap items-start justify-center gap-[clamp(1.5rem,3vw,3rem)]"
          stagger={0.1}
        >
